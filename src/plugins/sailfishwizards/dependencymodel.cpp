 ...
 * \param index Item number.
 */
ExternalLibrary DependencyModel::getExternalLibraryByIndex(int &index)
{
 ...
 */
QStringList DependencyModel::getQtList(int &index)
{
 ...
 */
QStringList DependencyModel::getDependencyList(int &index)
{
 ...
 * \param index External library number.
 */
QStringList DependencyModel::getTypesList(int &index)
{
 ...
 * \param index External library number.
 */
QString DependencyModel::getYamlHeader(int &index)
{
 ...
 * \param index External library number.
 */
QString DependencyModel::getSpecHeader(int &index)
{
