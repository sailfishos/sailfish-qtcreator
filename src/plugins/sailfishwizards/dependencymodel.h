...
public:
    ...
    int size() const;
    QStringList getQtList(int &index) const;
    QStringList getDependencyList(int &index) const;
    QStringList getTypesList(int &index) const;
    QString getYamlHeader(int &index) const;
    QString getSpecHeader(int &index) const;
    ExternalLibrary getExternalLibraryByIndex(int &index) const;
private:
