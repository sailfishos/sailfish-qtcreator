...
void OutputWindow::setFilterText(const QString &filterText)
{
    if (d->filterText != filterText) {
        ...
        if (filterText.isEmpty()) {
            ...
            QPalette pal;
            pal.setColor(QPalette::Active, QPalette::Base, QColor(Qt::GlobalColor::yellow).lighter());
            pal.setColor(QPalette::Inactive, QPalette::Base, QColor(Qt::GlobalColor::yellow).lighter());
